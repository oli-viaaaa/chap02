...
public class String02LongString { // class start
	public static void main(String[] args) {// main start
		...
		String[] str1 = str.split(" "); // 띄어쓰기를 기준으로 분리시키기
		...
		// 문제 1. 위의 str 데이터 중 "HTML5"단어가 몇번 노출되는지 노출 횟수를 resultNum이라는 배열명으로 저장하여 출력
		int count = 0;
		...
		for (int i = arrStr.length - 1; i >= 0; i--) { // 배열 갯수만큼이 아닌 -1
			System.out.print(arrStr[i] + "");
		}
		System.out.println();

		// 문제 2. 위의 str 데이터를 모두 역순(space 기준)으로 resultStr 변수 저장하여 출력
